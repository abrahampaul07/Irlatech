...
const Contact = () => {
  ...
  return (
    <>
    <Layout>
      <div className="flex items-center justify-center min-h-screen p-4 pt-20"> {/* Add pt-20 to create space below the navbar */}
        <div className="max-w-xl w-full bg-white bg-opacity-60 rounded-lg p-6 shadow-lg" style={{ backgroundColor: 'rgba(38, 38, 38, 0.4)' }}>
          <h1 className="text-[32px] md:text-[40px] font-bold text-center text-white">Contact Us</h1>
