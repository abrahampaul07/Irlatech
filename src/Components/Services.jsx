...
const servicesData = [
  {
    ...
    description: "Stay compliant and manage software licenses effectively, saving costs on unused or redundant licenses.",
    image: box1Image,
  },
  {
    title: "Cybersecurity Solutions",
    description: "Protect your business with top-notch cybersecurity measures, safeguarding sensitive data from threats.",
    image: box2Image,
  },
  {
    title: "Remote IT Support",
    description: "Get reliable 24/7 remote IT support to resolve issues quickly without the need for on-site visits.",
    image: box3Image,
  },
  {
    title: "Cloud Migration",
    description: "Seamlessly move your business to the cloud to improve flexibility and reduce infrastructure costs.",
    image: box4Image,
  },
  {
    title: "IT Infrastructure Optimization",
    description: "Maximize the efficiency of your existing IT assets by optimizing networks, hardware, and software.",
    image: box5Image,
  },
];
...
const Services = () => {
  ...
  return (
    ...
    <Layout>
      <div className="flex flex-col items-center justify-center min-h-screen p-4">
        <div className="text-center mb-10">
          ...
          <p className="mt-5 xl:text-lg text-white w-[90%] mx-auto italic">
            Our suite of IT solutions is designed to help businesses cut down on
            operational costs while maximizing efficiency and security. Explore
            our services that streamline your IT infrastructure, enhance
      ...
      <div ref={servicesRef} className="flex flex-col items-center p-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-9 w-full max-w-5xl mb-8">
          {servicesData.slice(0, 3).map((service, index) => (
            <div key={index} className="shadow-md p-4 flex flex-col h-full" style={{ backgroundColor: 'rgba(38, 38, 38, 0.4)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 xl:w-[55%] md:w-[65%] w-full max-w-5xl">
          {servicesData.slice(3).map((service, index) => (
            <div key={index + 3} className="shadow-md p-4 flex flex-col h-full" style={{ backgroundColor: 'rgba(38, 38, 38, 0.3)' }}>
              <div className="flex flex-col flex-1 items-center justify-center text-center">
                <img src={service.image} alt={service.title} className="w-full h-48 object-cover rounded-md mb-4" />
                <h2 className="text-lg font-semibold text-white">{service.title}</h2>
                <p className="mt-2 text-sm text-gray-300">{service.description}</p>
